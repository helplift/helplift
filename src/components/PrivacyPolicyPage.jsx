  ...
  return (
    <div className="privacy-policy-page">
      ...
      <p className="privacy-policy__date">
        Дата набрання чинності: <strong>01.11.2024</strong>
      </p>
      <p>
        Компанія HelpLift (далі – &quot;Компанія&quot;, &quot;ми&quot;, &quot;нас&quot;, &quot;наш&quot;) поважає вашу конфіденційність і дотримується
        законодавства України у сфері захисту персональних даних. Ця Політика конфіденційності описує, які дані ми
        збираємо, як їх використовуємо, захищаємо та розкриваємо.
      </p>
      ...
      <p>
        Ми вживаємо необхідні технічні та організаційні заходи для захисту ваших персональних даних від
        несанкціонованого доступу, втрати або знищення. Наші співробітники ознайомлені з вимогами щодо захисту
        інформації та зобов&apos;язані дотримуватися конфіденційності.
      </p>
      ...
      <p>
        Ми можемо оновлювати цю Політику конфіденційності. Усі зміни набирають чинності з моменту їх публікації на
        сайті. Рекомендуємо періодично переглядати цю Політику.
      </p>

      <h2 className="privacy-policy__section-title">8. Контактна інформація</h2>
      <p>
        Якщо у вас виникли запитання або пропозиції щодо цієї Політики конфіденційності, будь ласка, звертайтеся до
        нас за контактними даними, вказаними на нашому сайті.
      </p>
    </div>
  );
};
