...
import LightingProductPage from '@/components/LightingProductPage';

export async function generateStaticParams() {
  return productsLighting.map((product) => ({
    slug: product.slug,
  }));
}
...
export async function generateMetadata({ params }) {
  ...
  const canonicalUrl = `https://helplift.com.ua/products/lighting/${product.slug}`;

  return {
    title: `${product.name} — вуличне LED-освітлення`,
    description,
    keywords: [
      product.name,
      'вуличне освітлення',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Освітлення', item: 'https://helplift.com.ua/' },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            offers: {
              '@type': 'Offer',
              url: `https://helplift.com.ua/products/lighting/${product.slug}`,
              priceCurrency: 'UAH',
